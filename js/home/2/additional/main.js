...
let t = 10;
if ((s > f && s < t) || (s > t && s < f)) {
    console.log('s це середнє значення')
} else if (t < s && t < f) {
    console.log('помилка')
}*/
...
потрібно перевірити яким є число:
 позитивним, негативним або нулем
напишіть це тернарним оператором*/
let number = prompt()
number < 0 ? console.log('негативне') :
    number > 0 ? console.log('позитивне') : console.log('0')